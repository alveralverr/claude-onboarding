...
- `src/content/paths/`: `index.ts` (all twelve role cards) and one folder per live path (`admin/`: persona, shifts). Old section hashes (`#setup`, `#connectors`, ...) are aliased in `LEGACY` there.
