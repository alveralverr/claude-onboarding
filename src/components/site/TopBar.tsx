...
const NAV = [
  { href: "#/", label: "Office" },
  { href: "#/room/desk", label: "Your Desk" },
  { href: "#/room/inbox", label: "The Inbox" },
  { href: "#/room/vault", label: "The Vault" },
  ...
  return (
    <header className="sticky top-0 z-40 h-16 border-b bg-background/95">
      <div className="mx-auto flex h-full max-w-[1280px] items-center gap-4 px-5 md:px-10">
        <a href="#/" className="flex min-h-11 items-center gap-2 text-foreground no-underline" aria-label="The Magic Office, back to the lobby">
          ...
          <span className="ml-1.5 hidden border-l pl-3 text-[17px] font-semibold sm:inline">The Magic Office</span>
        </a>
          ...
          <Sheet open={open} onOpenChange={setOpen}>
            ...
            <SheetContent side="right" className="overflow-y-auto">
              <SheetHeader>
                ...
                <SheetDescription>Three core rooms, then the Shelf whenever you need it.</SheetDescription>
              </SheetHeader>
              <div className="flex flex-col gap-1 px-4 pb-6">
                <SheetLink href="#/">The office (lobby)</SheetLink>
                <p className="mt-2 mb-1 text-xs font-semibold tracking-[0.16em] text-muted-foreground uppercase">Core rooms</p>
                {PATH_STEPS.map((s) => (
                ...
                <p className="mb-1 text-xs font-semibold tracking-[0.16em] text-muted-foreground uppercase">The Shelf</p>
                {LIBRARY.map((l) => (
                ...
                <SheetLink href="#/shelf/help">Get help</SheetLink>
                <SheetLink href="#/shelf/feedback">Give feedback</SheetLink>
              </div>
            </SheetContent>
          </Sheet>
        </div>
